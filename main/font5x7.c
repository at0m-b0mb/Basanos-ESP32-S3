/* Basanos — 5x7 column-major bitmap font, ASCII 32..126.
 *
 * Each glyph is five bytes, one per column, bit 0 at the top row. Written out
 * rather than pulled from a library so the firmware carries no font licence.
 *
 * SPDX-License-Identifier: MIT
 */
#include <stdint.h>

const uint8_t bas_font5x7[95][5] = {
